class Count:
    ...
    def __init__(self, runs=None, trial=None, date=None, dps=None, tank=None, healer=None, event=None):
    ...
    def increase_data(self, runs=0, trial=None, date=None, dps=0, tank=0, healer=0,event=0):
        self.count += runs
        self.lastTrial = trial if trial is not None else "None"
        self.lastDate = date if date is not None else "<t:0:f>"
        self.dpsRuns += dps
    ...
    def decrease_data(self, runs=0, trial=None, date=None, dps=0, tank=0, healer=0,event=0):
        self.count -= runs
        self.lastTrial = trial if trial is not None else "None"
        self.lastDate = date if date is not None else "<t:0:f>"
        self.dpsRuns -= dps
